...
# File: collect_natura2000_sites_bfn.py
# Author: Markus Reinhold
# Contact: leaffan@gmx.net
# Creation Date: 2011/12/22 12:30:36

u"""
Uses a shapefile containing boundary and sitecode information for German Natura
2000 sites and then scrapes information about these sites from the BfN website.
Finally dumps all retrieved information to a pickle file.
"""
...
from habitat import Habitat, HabitatType, Species, SpeciesFinder
...
if __name__ == '__main__':
    ...
    hab_area_shp_src = r"Z:\work\ms.monina\wp4\shp\natura2000\natura2000_de_2010_utm32_orig.shp"
    hab_type_pkl_src = r"data\_habitat_types.pkl"
    # output data target
    hab_area_pkl_tgt = r"data\_natura_2000_de_2.pkl"
